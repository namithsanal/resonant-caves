 ...
 * {@code data/surfacesurvival/worldgen}) to every overworld biome, at roughly iron ore's rarity.
...
public final class ResonantOreWorldGen {
	...
	public static void register() {
		BiomeModifications.addFeature(
				...
				RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(SurfaceSurvival.MOD_ID, "resonant_ore")));
	}
}
