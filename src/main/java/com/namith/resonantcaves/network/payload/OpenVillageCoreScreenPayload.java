...
/** Server &rarr; client: tell the client to open the Village Core GUI at the saved depth. */
public record OpenVillageCoreScreenPayload(BlockPos pos, int depth) implements CustomPayload {
	...
	public static final PacketCodec<RegistryByteBuf, OpenVillageCoreScreenPayload> CODEC = PacketCodec.tuple(
			...
			PacketCodecs.VAR_INT, OpenVillageCoreScreenPayload::depth,
